...
public class PoolSpawnManager : BaseSingleton<PoolSpawnManager>
{
    ...
    void OnEnable()
    {
        // ❌ REMOVED: Auto-spawn khi loading xong đã bị tắt.
        // Spawn enemy giờ được điều khiển bởi QuestSpawnManager theo từng quest step.
    ...
    {
        OnRelease -= ReleaseToPool;
        // UILoading.OnLoadingComplete đã bị unsubscribe ở trên
    }

    // ❌ REMOVED: Không còn spawn toàn bộ map khi loading xong.
    // Logic spawn đã chuyển sang QuestSpawnManager.
